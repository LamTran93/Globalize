...
import 'package:booking_platform_app/widgets/screens/ui/room_detail/body_content_room.dart';
...
import 'check_info_booking_screen.dart';

class RoomDetailScreen extends StatefulWidget {
  final Room item;
  final PropertyDetail property;

  const RoomDetailScreen({super.key, required this.item, required this.property});
...
class _RoomDetailScreenState extends State<RoomDetailScreen>
  ...
  void initState() {
    ...
    _futureProperty = fetchDataPropertyDetails(widget.property.id);
    _futureRooms = fetchDataRooms(widget.property.id);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final index =
    cartOrder.cart.indexWhere((element) => element.propertyDetail.id == widget.property.id);
                    ...
                    child: SingleChildScrollView(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            BodyContentRoom(room:  widget.item, propertyDetail: widget.property)
                          ],
                        ),
                      ),
                    ),
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'USD ${cartOrder.cart[index].carts.fold(0.00, (total, element) => total + element.room.price * element.quantity)} ' +
